...
INSERT INTO advertisments (id, title, text, price, category) values (1, 'Title mig 1', 'Text 1', 2500, 'category');
INSERT INTO advertisments (id, title, text, price, category) values (2, 'Title mig 2', 'Text 2', 2500, 'category');
INSERT INTO advertisments (id, title, text, price, category) values (3, 'Title mig 3', 'Text 3', 2500, 'category');